...
async function main() {
    ...
    // 1. Seed Users
    const defaultPassword = await bcryptjs_1.default.hash('artevia123', 10);
    const users = [
        { email: 'administracion@arteviainmobiliaria.com', name: 'Administración Artevia', role: client_1.Role.ADMIN },
        { email: 'ventas@arteviainmobiliaria.com', name: 'Agente Ventas', role: client_1.Role.VENTAS },
        { email: 'gerencia@arteviainmobiliaria.com', name: 'Gerencia General', role: client_1.Role.GERENCIA },
        { email: 'marketing@arteviainmobiliaria.com', name: 'Jefe Marketing', role: client_1.Role.MARKETING },
        { email: 'soporte@arteviainmobiliaria.com', name: 'Soporte Técnico', role: client_1.Role.SOPORTE },
    ];
    ...
    const reps = [
        {
            ...
            email: 'avargas@arteviainmobiliaria.com',
        ...
        },
        {
            ...
            email: 'vtorres@arteviainmobiliaria.com',
        ...
        },
        {
            ...
            email: 'cmendoza@arteviainmobiliaria.com',
    ...
    const properties = [
        {
            ...
            location: 'La Molina',
            price: 1500000,
            operation: client_1.OperationType.VENTA,
            type: client_1.PropertyType.CASA,
            area: 450,
            beds: 4,
            baths: 5,
            image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
            ...
            featured: true,
            status: client_1.PropertyStatus.DISPONIBLE,
        ...
        },
        {
            ...
            location: 'San Isidro',
            price: 3500,
            operation: client_1.OperationType.ALQUILER,
            type: client_1.PropertyType.DEPARTAMENTO,
            area: 120,
            beds: 2,
            baths: 2,
            image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            price: 800000,
            operation: client_1.OperationType.VENTA,
            type: client_1.PropertyType.OFICINA,
            area: 85,
            beds: 1,
            baths: 2,
            image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
            ...
            featured: true,
            status: client_1.PropertyStatus.ALQUILADO,
